...
sim = FDTD_2D_Hz(x_range=14e-3, y_range=14e-3, Nx=140, Ny=140, f_min=200e9, f_max=300e9, Nt=1000)
sim.periodic = ['']
sim.add_PML(pml_width=20, direction='xy')

sim.add_circle(ER=5, MR=1, center=(6e-3, 9e-3), radius=0.5e-3, nsub=6)
sim.add_rectangle(ER=[4, 4, 4], MR=1, x_position=(6e-3, 8e-3), y_position=(6e-3, 9e-3))
