...
sim = FDTD_2D_Hz(x_range=14e-3, y_range=14e-3, Nx=140, Ny=140, f_min=f_min, f_max=f_max, Nt=1200)
sim.periodic = ['']
...
sim.show_FF(ff, freq_idx=np.arange(0, 3), component='Ephi')  # first frequency
