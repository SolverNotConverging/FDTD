...
sim = FDTD_2D_Hz(x_range=14e-3, y_range=14e-3, Nx=140, Ny=140, f_min=50e9, f_max=70e9, Nt=1000)
sim.periodic = ['']
...
sim.add_source('waveguide-x', y=(4e-3, 10e-3), x=22, amplitude=2, mode_index=1, modes_to_show=3, is_show=0)
sim.add_source('waveguide-y', x=(4e-3, 10e-3), y=22, amplitude=2, mode_index=1, modes_to_show=3, is_show=0)
