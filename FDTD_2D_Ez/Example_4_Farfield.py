...
sim = FDTD_2D(x_range=14e-3, y_range=14e-3, Nx=140, Ny=140, f_min=200e9, f_max=300e9, Nt=1000)
sim.periodic = ['']
...
# sim.add_rectangle(ER=[2, 2, 2], MR=1, x_position=(4e-3, 8e-3), y_position=(7e-3, 8e-3))
# sim.add_rectangle(ER=[10, 10, 10], MR=1, x_position=(6e-3, 8e-3), y_position=(8e-3, 8.1e-3))

sim.add_source('waveguide-y', x=(2e-3, 12e-3), y=6.1e-3, amplitude=2, mode_index=1, modes_to_show=4)
