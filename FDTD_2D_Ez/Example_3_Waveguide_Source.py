...
sim.add_source('waveguide-x', y=(4e-3, 10e-3), x=22, amplitude=1, mode_index=2, modes_to_show=3, is_show=1)
sim.add_source('waveguide-y', x=(4e-3, 10e-3), y=22, amplitude=2, mode_index=1, modes_to_show=3, is_show=1)
